...
class Action extends XmlElement
{
    ...
    public function toArray(string $defaultLocale): array
    {
        ...
        return array_merge($data, [
            ...
            'config' => array_map(fn (InputField $config): array => $config->jsonSerialize(), $this->config->getConfig()),
            'headers' => array_map(fn (Parameter $header): array => $header->jsonSerialize(), $this->headers->getParameters()),
    ...
    {
        $parameters = array_map(fn (Parameter $parameter): array => $parameter->jsonSerialize(), $this->parameters->getParameters());
