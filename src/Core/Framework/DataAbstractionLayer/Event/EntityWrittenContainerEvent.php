...
class EntityWrittenContainerEvent extends NestedEvent
{
    ...
    {
        return $this->findPrimaryKeys($entity, fn (EntityWriteResult $result): bool => $result->getOperation() === EntityWriteResult::OPERATION_DELETE);
    }
    ...
    public function getPrimaryKeysWithPayload(string $entity): array
    {
        ...
        return $this->findPrimaryKeys($entity, function (EntityWriteResult $result): bool {
    ...
    {
        return $this->findPrimaryKeys($entity, function (EntityWriteResult $result) use ($ignoredFields): bool {
            if ($result->getOperation() === EntityWriteResult::OPERATION_DELETE) {
                return true;
            }
    ...
    {
        return $this->findPrimaryKeys($entity, function (EntityWriteResult $result) use ($properties): bool {
