...
class VersionCommitCollection extends EntityCollection
{
    ...
    {
        return $this->fmap(fn (VersionCommitEntity $versionChange): ?string => $versionChange->getUserId());
    }

    public function filterByUserId(string $id): self
    {
        return $this->filter(fn (VersionCommitEntity $versionChange): bool => $versionChange->getUserId() === $id);
    }
