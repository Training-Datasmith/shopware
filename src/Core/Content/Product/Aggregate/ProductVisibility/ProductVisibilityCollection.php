...
class ProductVisibilityCollection extends EntityCollection
{
    ...
    {
        return $this->fmap(fn (ProductVisibilityEntity $visibility): string => $visibility->getProductId());
    }

    public function filterByProductId(string $id): self
    {
        return $this->filter(fn (ProductVisibilityEntity $visibility): bool => $visibility->getProductId() === $id);
    }

    public function filterBySalesChannelId(string $id): self
    {
        return $this->filter(fn (ProductVisibilityEntity $visibility): bool => $visibility->getSalesChannelId() === $id);
    }
