...
class SalesChannelCmsPageLoader implements SalesChannelCmsPageLoaderInterface
{
    ...
    public function load(
        ...
        foreach ($pages as $page) {
            ...
            $sections->sort(fn (CmsSectionEntity $a, CmsSectionEntity $b): int => $a->getPosition() <=> $b->getPosition());
            ...
            foreach ($sections as $section) {
                ...
                $blocks->sort(fn (CmsBlockEntity $a, CmsBlockEntity $b): int => $a->getPosition() <=> $b->getPosition());
                ...
                foreach ($blocks as $block) {
                    ...
                    $slots->sort(fn (CmsSlotEntity $a, CmsSlotEntity $b): int => $a->getSlot() <=> $b->getSlot());
                }
            }
