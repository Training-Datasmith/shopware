...
class OrderCustomerCollection extends EntityCollection
{
    ...
    {
        return $this->fmap(fn (OrderCustomerEntity $orderCustomer): ?string => $orderCustomer->getCustomerId());
    }

    public function filterByCustomerId(string $id): self
    {
        return $this->filter(fn (OrderCustomerEntity $orderCustomer): bool => $orderCustomer->getCustomerId() === $id);
    }

    public function getCustomers(): CustomerCollection
    {
        return new CustomerCollection(
            $this->fmap(fn (OrderCustomerEntity $orderCustomer): ?\Shopware\Core\Checkout\Customer\CustomerEntity => $orderCustomer->getCustomer())
        );
    }
